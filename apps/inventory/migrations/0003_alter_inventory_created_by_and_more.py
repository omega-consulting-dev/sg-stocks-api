...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='inventory',
            name='validated_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='validated_inventories', to='accounts.user', verbose_name='Validé par'),
        ),
        migrations.AlterField(
            model_name='stock',
            name='created_by',
