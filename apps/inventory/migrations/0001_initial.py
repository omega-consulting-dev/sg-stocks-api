    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='validated_inventories', to=settings.AUTH_USER_MODEL, verbose_name='Validé par')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_value', models.DecimalField(blank=True, decimal_places=2, help_text='Montant total de la ligne (avec taxes) pour les ventes/factures', max_digits=12, null=True, verbose_name='Montant total')),
                ('invoice_amount', models.DecimalField(blank=True, decimal_places=2, help_text='Montant total de la facture (peut différer de unit_cost * quantity)', max_digits=12, null=True, verbose_name='Montant de la facture')),
                ('receipt_number', models.CharField(blank=True, help_text="Numéro de la pièce d'entrée en stock", max_length=50, null=True, unique=True, verbose_name='Numéro de pièce')),
                ('reference', models.CharField(blank=True, help_text='Référence du bon de livraison ou facture', max_length=100, verbose_name='Référence document')),
                ('notes', models.TextField(blank=True, verbose_name='Notes')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL, verbose_name='Créé par')),
            ],
            options={
